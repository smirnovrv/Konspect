...
Процедура РедактироватьПриИзменении(Элемент)
	УстановитьВидимость(Редактировать);
//	
//	//есть текст который нужно либо добавить, либо вставить
//	Если ЗначениеЗаполнено(ТекстСтроки) Тогда
//		Если Элементы.Состав.ТекущаяСтрока = Неопределено Тогда //Новая строка
//			ВыбранноеЗначение = Новый Структура;
//			ВыбранноеЗначение.Вставить("ВведенныйТекст"	, ТекстСтроки);
//			ВыбранноеЗначение.Вставить("Тэг"			, ПредопределенноеЗначение("Справочник.Тэги.p"));
...
//		
//		Модифицированность 		= Истина;
//	Иначе // флаг включили или изменили ранее, при выделении текста
...
Процедура КомандаВвестиТекст(Команда)
	...
	УстановитьВидимость(Не Элементы.ГруппаРедактирования.видимость);
...
Процедура КомандаДобавитьТекст(Команда)
	...
	Если ЗначениеЗаполнено(ТекстСтроки) Тогда
		ДобавитьСтрокуТаблицы(ТекстСтроки);
...
Процедура ИзменитьВыделенное(Структура)
	...
	Если Не ВыделенныйТекстДо = "" Тогда //Если ВыделенныйТекст заполнен 
		...
		// должно работать как и при довлении строки
//		Если Не Элементы.Состав.ТекущиеДанные = Неопределено Тогда
...
//			
//			Если Структура.Заголовок Тогда
...
&НаКлиенте
Процедура УстановитьВидимость(Редактируется)

	Элементы.ГруппаРедактирования.Видимость 	= Редактируется;
	Элементы.Состав.Видимость 					= Редактируется;	
	Элементы.ГруппаОсновнойТекст.Видимость 		= Не Редактируется;
	Элементы.ПредпросмотрHTML.Видимость  		= Редактируется;
	Элементы.ГруппаПоля.Видимость 				= Редактируется;
...
&НаСервере
Процедура ДобавитьСтрокуТаблицы(ТекстДобавления)
