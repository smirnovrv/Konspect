...
Процедура КомандаЖирный(Команда)  
    ...
    Док.documentElement.innerText = "234";
	//ВыделенныйТекст = Элементы.ОсновнойТекстРасширеннаяПодсказка.Родитель.ВыделенныйТекст;
	//ТекстВставки = ВыделенныйТекст;
	//ТекстВставки = "<b>" + ТекстВставки + "</b>"; ; 
	//Элементы.ОсновнойТекстРасширеннаяПодсказка.Родитель.ВыделенныйТекст = "";
	//Элементы.ОсновнойТекстРасширеннаяПодсказка.Родитель.ВыделенныйТекст = ТекстВставки;	
КонецПроцедуры
